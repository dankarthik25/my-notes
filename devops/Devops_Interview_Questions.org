...
* TODO Install Jenkins inside Docker
Write Docker file and run Docker build and run Jenkins 
https://patharetanmay1018.medium.com/automation-with-custom-jenkins-image-by-using-dockerfile-2f2e9aa3c1cd
Try using tomcaat
* TODO Install Tomcat inside Docker
install tomcat and use jenkins to deploy artifacts to tomcat server
* Sonarqube
* Jfrog
* AWS
EC2
...
VPC
* Terra frorm
* Create Cluster using Micro servers in docker
* ELC
* Nagios
